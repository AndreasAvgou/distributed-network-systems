...
if __name__ == "__main__":
    ...
    node1 = Node('127.0.0.1', 5000, [('127.0.0.1', 5001), ('127.0.0.1', 5002)])
    node2 = Node('127.0.0.1', 5001, [('127.0.0.1', 5000), ('127.0.0.1', 5002)])
    node3 = Node('127.0.0.1', 5002, [('127.0.0.1', 5000), ('127.0.0.1', 5001)])
    ...
    node1.send_message("INIT", ('127.0.0.1', 5000))
